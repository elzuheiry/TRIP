        ...
        <div class="container">
            <div class="verification-content">
                <form action="<?php echo $_SERVER["PHP_SELF"] ?>" method="POST">
                    ...
                    <div class="input">
                        <div class="boxInput">
                            <input type="text" placeholder=" " autocomplete="off" name="verifyCode" />
                            <label for="">Type here your code</label>
                        </div>
                        <div class="errorMessage" id="verifyCodeError">
                            <?php echo $verifyErrors["verifyCode"]; ?>
                        </div>
                    </div>

                    <button class="btn-verification button" type="submit" name="Verify">Verified</button>
                </form>
            </div>
        </div>
    </div>
